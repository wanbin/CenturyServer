...
-- 创建数据库 -- 
CREATE DATABASE `game_1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
use game_1;
-- 方法性能分析 --
...
`count` int(10) default "0" COMMENT '' )ENGINE=InnoDB DEFAULT CHARSET=utf8;use game_1;-- 测试数据库连接 --
CREATE TABLE `testContent`(
	`gameuid` int(10) default "0" COMMENT '', 
`count` int(10) default "0" COMMENT '', 
 PRIMARY KEY  (`gameuid`,`count`))ENGINE=InnoDB DEFAULT CHARSET=utf8;use game_1;-- 用户基本信息表 --
...
`authcode` int(6) default "0" COMMENT '玩家UID', 
 PRIMARY KEY  (`gameuid`))ENGINE=InnoDB DEFAULT CHARSET=utf8;use game_1;-- 用户建筑表 --
CREATE TABLE `user_building`(
	`gameuid` int(10) default "0" COMMENT '玩家GAMEUID', 
`crop` int(5) default "0" COMMENT '资源地1', 
`cropupdatetime` int(10) default "0" COMMENT '收获时间', 
 PRIMARY KEY  (`gameuid`))ENGINE=InnoDB DEFAULT CHARSET=utf8;use game_1;-- 用户Mapping映射表 --
...
`uid` varchar(100) COMMENT '用户UID数据', 
 PRIMARY KEY  (`gameuid`), UNIQUE KEY `uid` (`uid`))ENGINE=InnoDB
 DEFAULT CHARSET=utf8;use game_1;-- 用户正在生产的信息表 --
