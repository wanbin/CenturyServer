 ...
 */
require_once PATH_DATAOBJ . 'CommandAnalysisModel.php';
class CommandAnalysisCache extends CommandAnalysisModel{
	private $item = array ();
	...
	private function getCacheKeyAll() {
		return sprintf ( MEMCACHE_KEY_COMMANDANALYSIS_ALL, $this->gameuid );
	}
}