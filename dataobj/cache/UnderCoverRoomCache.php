 ...
 */
require_once PATH_DATAOBJ . 'UnderCoverRoomModel.php';
class UnderCoverRoomCache extends UnderCoverRoomModel{
	...
	private function getCacheKey($id) {
		return sprintf ( MEMCACHE_KEY_UNDERCOVERROOM,$this->gameuid ,$id );
	}
	
	private function getCacheKeyAll() {
		return sprintf ( MEMCACHE_KEY_UNDERCOVERROOM_ALL, $this->gameuid );
	}
}